...
// ⚡ Bolt: Wrapped with React.memo to prevent re-renders when other form fields change.
// Now accepting primitive values (error, isTouched, value) instead of full Formik objects.
const FormQuestion = React.memo(({ item, error, isTouched, value, showErrors }: Props) => {
  ...
  // ⚡ Bolt: Replaced sync document.getElementById with a check against the passed-in value prop
