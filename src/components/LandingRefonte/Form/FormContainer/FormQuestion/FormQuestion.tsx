...
type Props = {
  ...
  isTouched?: boolean;
  value?: string;
  showErrors?: boolean; // eslint-disable-line @typescript-eslint/no-unused-vars
};

const FormQuestion = ({ item, error, isTouched, value, showErrors }: Props) => { // eslint-disable-line @typescript-eslint/no-unused-vars
