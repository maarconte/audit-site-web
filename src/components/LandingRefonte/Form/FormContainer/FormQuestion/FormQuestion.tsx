...
// Since it now receives primitive values (error, isTouched, value) instead of full Formik objects,
// it will only re-render when its specific field changes, improving performance on large forms.
